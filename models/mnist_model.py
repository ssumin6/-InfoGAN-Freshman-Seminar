...
class Generator(nn.Module):
    def __init__(self):
        ...
        self.transconv1 = nn.ConvTranspose2d(128, 64, 4, 2)
        self.batchnorm = nn.BatchNorm2d(64)
        self.transconv2 = nn.ConvTranspose2d(64, 1, 4)

    def forward(self, x):
        img = self.linear(x)
        # resize the tensor into shape [batch_size, 7, 7, 128]
        img = img.view(-1, 7, 7, 128)
...
class Discriminator(nn.Module):
    def __init__(self):
        ...
        self.convs = nn.Sequential(
            ...
            nn.Conv2d(self.nchannels, 64, 4, stride=2),
    ...
    def forward(self, x):
        ...
        fc = nn.Linear(flatten_shape, 1024)
...
class QHead(nn.Module):
    def __init__(self):
        ...
        self.fcmu = nn.Linear(128, 2)
        self.fcvar = nn.Linear(128, 2)
        self.fclogits = nn.Linear(128, 10)
